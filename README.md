...
GoDoc at https://godoc.org/github.com/h0cheung/go-shadowsocks2/
...
Pre-built binaries are available from https://github.com/h0cheung/go-shadowsocks2/releases

You can also build from source:

```sh
go get -u -v github.com/h0cheung/go-shadowsocks2
```
